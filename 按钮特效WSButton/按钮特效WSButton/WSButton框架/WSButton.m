...
-(instancetype)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        ...
        _shapeLayer.fillColor = [UIColor clearColor].CGColor;//按钮颜色
        _shapeLayer.strokeColor = [UIColor whiteColor].CGColor;//按钮边框颜色
...
-(void)loadingAnimation{
    ...
    [self performSelector:@selector(removeAllAnimation) withObject:self afterDelay:0];
